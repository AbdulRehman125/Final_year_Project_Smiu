...
import { Clock, BookOpen, AlertCircle, CheckCircle2, ChevronRight, WifiOff } from "lucide-react";
      ...
      <main className="w-full max-w-2xl mx-auto flex-1 flex flex-col justify-center px-4 py-10">
        ...
        <div className="grid grid-cols-3 gap-3 mb-5">
          ...
          <div className="bg-white dark:bg-card border border-slate-200/80 dark:border-border/60 rounded-2xl p-4 text-center shadow-sm">
            <div className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Passages</div>
            <div className="text-lg font-black text-slate-900 dark:text-slate-100 leading-tight">3</div>
            <div className="text-[10px] font-semibold text-sky-600 dark:text-sky-400 mt-0.5">Easy → Hard</div>
          </div>
          <div className="bg-white dark:bg-card border border-slate-200/80 dark:border-border/60 rounded-2xl p-4 text-center shadow-sm">
            ...
            <div className="text-[10px] text-slate-400 mt-0.5">13 + 14 + 13</div>
          </div>
        </div>
