...
// function isValidResults(v: unknown): v is WritingEvaluationResponse {
//   if (!v || typeof v !== "object") return false
//   const r = v as Record<string, unknown>
//   return (
//     !!r.task1_score &&
//     !!r.task2_score &&
//     typeof r.overall_writing_band !== "undefined"
//   )
// }
...
//     if (!stored) {
//       // Nothing to show — most likely the candidate opened this URL directly
//       // without finishing a test. Send them back rather than a blank page.
//       router.push("/writing")
//       return
//     }
...
//   // ── Corrupted / unreadable results — don't dump a blank or broken screen ──
//   if (loadFailed) {
//     return (
...
//           Your results seem to be missing or corrupted in this browser. This can happen after
//           clearing site data or opening the page in a new tab. Please retake the test to get a
//           fresh score.
//         </p>
