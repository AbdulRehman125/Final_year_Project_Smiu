...
from schemas.writing_schema import Task1ChartData
...
class GeneratedTask1Question(BaseModel):
    id: str
    chart_type: str           # bar_chart | line_graph | pie_chart | table | process_diagram | letter
    prompt_text: str          # Full question text shown to user
    description: str          # What chart shows (used by evaluator agent)
    chart_data: Optional[Task1ChartData] = None  # None for General Training (letter)
    test_type: str            # academic | general
